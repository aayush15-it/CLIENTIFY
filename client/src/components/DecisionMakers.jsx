...
import { ExternalLink, Mail, Users, Copy, Check } from 'lucide-react';

export default function DecisionMakers({ people, selectedDMIndex, setSelectedDMIndex }) {
      ...
      <div className="space-y-4 overflow-y-auto max-h-[500px] pr-2 custom-scrollbar">
        {peopleList.map((person, i) => (
          <div 
            ...
            className={`group bg-[#0A1428]/50 border rounded-xl p-4 transition-all cursor-pointer ${
              selectedDMIndex === i ? 'border-[#00D4FF]/80 ring-1 ring-[#00D4FF]' : 'border-white/5 hover:border-white/20'
            }`}
          >
